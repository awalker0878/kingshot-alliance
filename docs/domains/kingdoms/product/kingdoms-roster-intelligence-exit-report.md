...
This acceptance does **not** approve a real production cutover. Production remains governed separately by [production launch approval](../../../product/production-launch-approval.md), including external infrastructure/operator evidence that repository CI cannot prove.
