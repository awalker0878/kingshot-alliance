...
Despite this file's historical path, **no Events-to-Contributions reconciliation/materialization workflow exists in the final model**. Events remains authoritative for Event facts; Contributions composes those facts at query/report time.
