...
Operations owns live Event execution. Platform `EventAdministration` owns system-wide Event-type administration but not Event execution. Intelligence `EventAnalysis` consumes Event facts for history/analytics without mutating Events.
