...
- [Kingdoms CSV migration security review](kingdoms-csv-security-review.md) — validated-candidate Slice D review for untrusted CSV parsing, identity ambiguity, preview/commit drift, batch atomicity/idempotency, formula injection, private export fields, provenance and tenant isolation.
