...
- [Kingdoms intelligence security review](kingdoms-intelligence-security-review.md) — validated-candidate Slice C2 review for tenant-scoped aggregation, missing/stale-data interpretation, bounded trend windows, exact arithmetic, comparison privacy, and anti-ranking controls.
- [Kingdoms CSV migration security review](kingdoms-csv-security-review.md) — Slice D implementation-candidate review for untrusted CSV parsing, identity ambiguity, preview/commit drift, batch atomicity/idempotency, formula injection, private export fields, provenance and tenant isolation.
