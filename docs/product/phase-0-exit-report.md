...
Phase 0 is **Accepted** against the five exit criteria approved in the [implementation plan](implementation-plan.md). Phase 1 may begin after PR #2 is merged to `main`.
