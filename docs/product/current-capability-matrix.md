...
Use the implemented-capability table to answer “is this available in the accepted product?” Use the post-program increment table to distinguish Accepted implementation from Approved/In-progress scope. Use explicit boundaries to answer what is deliberately **not** part of the runtime.
