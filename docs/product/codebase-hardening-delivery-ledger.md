...
- Remaining collections: participation rows, roster/Rally assignments and eligible Governor selectors, results, reminder rules and EventPlayerIntelligence full-history aggregates remain independently unbounded. This slice does not close HARD-134 or claim that one occurrence bounds its nested rows. ADR-0076 records the precise scope.
