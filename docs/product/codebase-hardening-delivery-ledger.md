...
- Exact next action: Publish the member-history type/navigation and reviewed visual corrections, finish the underway HARD-090 configuration/intake limits and regression cases, then HARD-088/093 and the remaining capability audit.
