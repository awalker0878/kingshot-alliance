...
- Formal [Phase 1 threat model](../security/phase-1-threat-model.md).
- [Migration/rollback strategy](../operations/phase-1-migration-rollback.md).
- Targeted [Phase 1 accessibility review](phase-1-accessibility-review.md).
- Updated [security baseline](../security/security-baseline.md).
