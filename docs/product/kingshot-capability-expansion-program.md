...
Acceptance: notification fingerprints are stable; retries do not duplicate meaning; revoked authority prevents future protected delivery; content has no unsupported conclusions; failed/unavailable/dismissed states are explicit; in-app/email/webhook presentation is localized, accessible and privacy-safe.
