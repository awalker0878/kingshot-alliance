...
| Integration | Committed state, independent connections, locking, after-commit and infrastructure | 54 | 539 |
...
| **PHP total** | **Each file and case assigned once** | **295** | **1,549** |
