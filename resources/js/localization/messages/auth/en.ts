...
const messages = {
  ...
  authExperience: {
    ...
    confirm: {
      ...
      description: 'Use one of your attached sign-in methods before continuing with this sensitive account change.',
    ...
    shell: {
      ...
      intro: 'Recruit Governors, prepare Events, manage your Alliance, and keep track of the Kingdom in one place.',
    },
    login: {
      intro: 'Sign in with any method attached to your Kingshot Alliance account, then choose the Governor you want to use.',
      invitationNotice: 'Sign in with the invited account to continue accepting your Alliance invitation.',
      needAccount: 'Need an account?',
      register: 'Register',
    },
    register: {
      intro: 'Create one Kingshot Alliance account. You can attach more sign-in methods later from Security settings.',
      invitationNotice: 'You were invited to {alliance} as {email}. Creating your account will also accept this invitation.',
      invitationOnly: 'Registration is currently invitation-only. Open the invitation link sent by your Alliance.',
      timezone: 'Time zone',
    ...
    invitation: {
      ...
      wrongAccount: 'You are signed in as {email}. Sign in with the invited email address to accept this invitation.',
    ...
    password: {
      ...
      recoveryNeutral: 'If an eligible password credential exists for that email, we will send secure password-reset instructions.',
      checkInboxKicker: 'CHECK YOUR INBOX',
      checkInboxHeading: 'Recovery instructions requested',
      checkInboxDescription: 'If an eligible password credential exists for the address you entered, password-reset instructions have been sent. For security, we cannot confirm whether an account exists or which methods it uses.',
      ...
      confirmDescription: 'This changes protected Alliance access, so confirm your identity before continuing.',
    },
    verification: {
      ...
      securityNote: 'Kingshot Alliance will never ask for your password through an email verification message.',
