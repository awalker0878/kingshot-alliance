...
const messages = {
  ...
  accountExperience: {
    account: {
      ...
      passwordUpdated: 'パスワードを更新し、他の認証済みセッションからサインアウトしました。',
      ...
      twoFactorIntro:
        '認証アプリでサインインを保護します。リカバリーコードは作成または再生成時のみ表示されます。',
      startSetup: '設定を開始',
      ...
      passwordIntro:
        'パスワードを変更すると他の端末からサインアウトし、その他のアクティブなアクセスも終了します。',
      currentPassword: '現在のパスワード',
      newPassword: '新しいパスワード',
      confirmNewPassword: '新しいパスワードを確認',
      updatePassword: 'パスワードを更新',
      sessionsTitle: 'その他のセッション',
      sessionsIntro: 'この端末以外の認証済みセッションからすべてサインアウトします。',
