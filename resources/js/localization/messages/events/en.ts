...
const messages = {
  events: {
    ...
    bulk: {
      eyebrow: 'Event bulk actions',
      selectVisible: 'Select manageable events',
      clearVisible: 'Clear visible selection',
      selectEvent: 'Select {event}',
      selected: '{count} event series selected',
      help: 'Preview current lifecycle and management permission before cancelling future occurrences.',
      preview: 'Preview cancellations',
      previewing: 'Checking events…',
      previewTitle: 'Cancellation preview',
      previewSummary: '{ready} ready and {blocked} blocked or already cancelled.',
      confirmTitle: 'Confirm event cancellations',
      confirmDescription: 'Cancel {count} eligible event series and their future occurrences?',
      confirm: 'Cancel eligible events',
      applying: 'Cancelling events…',
      resultTitle: 'Cancellation result',
      resultSummary:
        '{succeeded} succeeded, {failed} failed, and {skipped} were already cancelled.',
      failedSelected: 'Failed events remain selected so you can review and retry them.',
      outcomes: {
        ready: 'Ready',
    ...
    show: {
      ...
      knowledgeEyebrow: 'Reviewed Alliance knowledge',
