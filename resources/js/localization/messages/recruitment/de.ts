...
const messages = {
  recruitment: {
    searchChoices: 'Auswahl durchsuchen',
    findChoices: 'Suchen',
    noChoices: 'Keine passenden Einträge.',
    choiceLookupFailed: 'Die Auswahl konnte nicht geladen werden. Versuche es erneut.',
    activeConfigurationLimit:
      'Bis zu {limit} aktive Einträge. Deaktiviere einen Eintrag, um Platz für einen weiteren zu schaffen.',
    ...
    bulkPreviewHelp:
      'Prüfe vor der Änderung, wer verschoben werden kann. Nicht berechtigte Kandidaten bleiben unverändert.',
    previewBulkAction: 'Phasenänderung prüfen',
    bulkPreview: 'Vorschau der Phasenänderung',
    bulkPreviewSummary:
      '{ready} können aktualisiert werden; {blocked} müssen geprüft werden oder sind bereits in der Zielphase.',
    ...
    bulkResultSummary:
      '{succeeded} aktualisiert. {failed} müssen geprüft werden. {skipped} waren bereits aktuell.',
    failedItemsSelected:
      'Kandidaten, die nicht aktualisiert werden konnten, bleiben zur Prüfung ausgewählt.',
