...
const messages = {
  recruitment: {
    searchChoices: 'Pesquisar opções',
    findChoices: 'Pesquisar',
    noChoices: 'Nenhuma opção correspondente.',
    choiceLookupFailed: 'Não foi possível carregar as opções. Tente novamente.',
    activeConfigurationLimit: 'Até {limit} itens ativos. Desative um item para adicionar outro.',
    ...
    bulkPreviewHelp:
      'Revise quem pode mudar de etapa antes de aplicar a alteração. Candidatos não elegíveis permanecem sem mudanças.',
    previewBulkAction: 'Revisar mudança de etapa',
    bulkPreview: 'Prévia da mudança de etapa',
    bulkPreviewSummary:
      '{ready} podem ser atualizados e {blocked} precisam de revisão ou já estão na etapa de destino.',
    ...
    bulkResultSummary:
      '{succeeded} atualizados. {failed} precisam de revisão. {skipped} já estavam atualizados.',
    failedItemsSelected:
      'Os candidatos que não puderam ser atualizados permanecem selecionados para revisão.',
