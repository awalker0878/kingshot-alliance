...
const messages = {
  recruitment: {
    ...
    bulkPreviewHelp: 'Revisa quién puede cambiar de etapa antes de aplicar el cambio. Los candidatos no elegibles permanecen sin cambios.',
    previewBulkAction: 'Revisar cambio de etapa',
    bulkPreview: 'Vista previa del cambio de etapa',
    bulkPreviewSummary: '{ready} pueden actualizarse y {blocked} necesitan revisión o ya están en la etapa objetivo.',
    ...
    bulkResultSummary: '{succeeded} actualizados. {failed} necesitan revisión. {skipped} ya estaban al día.',
    failedItemsSelected: 'Los candidatos que no pudieron actualizarse siguen seleccionados para que puedas revisarlos.',
