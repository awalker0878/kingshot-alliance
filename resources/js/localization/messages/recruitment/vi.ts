...
const messages = {
  recruitment: {
    ...
    bulkPreviewHelp:
      'Kiểm tra ai có thể chuyển giai đoạn trước khi áp dụng thay đổi. Ứng viên không đủ điều kiện sẽ không thay đổi.',
    previewBulkAction: 'Kiểm tra thay đổi giai đoạn',
    bulkPreview: 'Xem trước thay đổi giai đoạn',
    bulkPreviewSummary:
      '{ready} có thể cập nhật và {blocked} cần xem lại hoặc đã ở giai đoạn đích.',
    ...
    bulkResultSummary:
      '{succeeded} đã cập nhật. {failed} cần xem lại. {skipped} đã ở trạng thái mới nhất.',
