...
const messages = {
  recruitment: {
    ...
    bulkPreviewSummary: '{ready} يمكن تحديثهم و{blocked} يحتاجون إلى مراجعة أو هم بالفعل في المرحلة المطلوبة.',
    ...
    bulkResultSummary: 'تم تحديث {succeeded}. يحتاج {failed} إلى مراجعة. كان {skipped} محدثًا بالفعل.',
