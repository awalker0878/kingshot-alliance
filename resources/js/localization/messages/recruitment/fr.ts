...
const messages = {
  recruitment: {
    ...
    bulkPreviewHelp: 'Vérifiez qui peut changer d’étape avant d’appliquer la modification. Les candidats non admissibles restent inchangés.',
    previewBulkAction: 'Vérifier le changement d’étape',
    bulkPreview: 'Aperçu du changement d’étape',
    bulkPreviewSummary: '{ready} peuvent être mis à jour et {blocked} nécessitent une vérification ou sont déjà à l’étape cible.',
    ...
    bulkResultSummary: '{succeeded} mis à jour. {failed} nécessitent une vérification. {skipped} étaient déjà à jour.',
    failedItemsSelected: 'Les candidats qui n’ont pas pu être mis à jour restent sélectionnés pour vérification.',
