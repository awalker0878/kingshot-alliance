...
const messages = {
  ...
  application: {
    dashboard: {
      commandStates: { assessment_incomplete: 'Wymagana dalsza ocena' },

      commandReasons: {
        transferAssessmentIncomplete:
          'Co najmniej {count} uczestników transferu wymaga uwagi; {unassessed} pozostaje nieocenionych w tym przeglądzie',
      },
