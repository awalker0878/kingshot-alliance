...
const messages = {
  common: {
    ...
    currentPlayer: 'Mevcut Vali',
    noPlayers: 'Bu hesaba bağlı Vali yok.',
    active: 'Etkin',
  ...
  application: {
    dashboard: {
      ...
      governorBriefing: 'Vali özeti',
      needsYourAttention: 'Dikkatini gerektiriyor',
      openActions: '{count} açık işlem',
      caughtUp: 'Her şey tamam',
      unreadNotifications: '{count} okunmamış bildirim',
      reviewNotifications: 'Bildirimleri ve teslim sorunlarını incele',
      giftCodesToRedeem: 'Kullanılacak {count} Hediye Kodu',
      overdueRecruitment: 'Gecikmiş {count} üye alımı takibi',
      recruitmentFollowUpDue: 'Aday takibi gerekiyor',
      noUrgentActions: 'Vali için acil işlem yok. Hazır olduğunda aşağıdaki bölümleri incele.',
      eventActionResponse: 'Uygunluğunu bildir',
      eventActionRegistration: 'Bu Etkinliğe kaydol',
      eventActionVote: 'Etkinlik anketinde oy ver',
      eventActionRosterConfirmation: 'Etkinlik kadrosu atamanı onayla',
      eventActionRequired: 'Etkinlik işlemi gerekiyor',
      allianceShortcuts: 'İttifak kısayolları',
      allianceShortcutsHelp: 'En sık kullandığın İttifak alanlarını aç.',
      nextOnCalendar: 'Takvimde sıradaki',
