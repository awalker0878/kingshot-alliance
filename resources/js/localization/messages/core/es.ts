...
const messages = {
  ...
  application: {
    dashboard: {
      commandStates: { assessment_incomplete: 'Se necesita más evaluación' },

      commandReasons: {
        transferAssessmentIncomplete:
          'Al menos {count} participantes del traslado necesitan atención; {unassessed} siguen sin evaluar en este resumen',
      },
