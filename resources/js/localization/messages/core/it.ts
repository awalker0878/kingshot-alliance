...
const messages = {
  ...
  application: {
    dashboard: {
      ...
      playerContextIntro:
        'Cambiare giocatore cambia l’identità di gioco usata per le autorizzazioni di alleanza e regno.',
      ...
      noPlayerAllianceIntro:
        'Cambia giocatore oppure crea/unisciti a un’alleanza con il giocatore attivo prima di aprire gli strumenti dell’alleanza.',
      ...
      createIntro:
        'Crea un’alleanza per il giocatore attivo. Il regno dell’alleanza deriva da quel giocatore, che diventa l’R5 iniziale.',
