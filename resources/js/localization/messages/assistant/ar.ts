  ...
  assistant: {
    ...
    answers: {
      transferVerificationIncomplete:
        'قيّمت هذه النظرة العامة {assessed} من أصل {total} مشاركًا في النقل. يحتاج {count} منهم على الأقل إلى الانتباه؛ ولم يُقيّم {unassessed} هنا. افتح جاهزية النقل لإجراء الفحوص الحالية.',
