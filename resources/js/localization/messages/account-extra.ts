...
type AccountExperienceTree = {
  accountExperience: {
    account: { [K in keyof typeof en.accountExperience.account]: string };
    deletion: { [K in keyof typeof en.accountExperience.deletion]: string };
  };
};

export const accountExperienceMessages: Record<LocaleCode, AccountExperienceTree> = {
  en,
  ar: {
    accountExperience: {
      account: {
  ...
  es: {
    accountExperience: {
      account: {
        ...
        passwordUpdated:
          'Tu contraseña se actualizó y se cerraron las demás sesiones autenticadas.',
  ...
  ja: {
    accountExperience: {
      ...
      deletion: {
        ...
        confirm:
          'アカウント削除を申請しますか？7日間の待機期間と所有権・法的保留の確認があります。',
  ...
  'pt-BR': {
    accountExperience: {
      account: {
        ...
        passwordUpdated:
          'Sua senha foi atualizada e as outras sessões autenticadas foram revogadas.',
  ...
  ru: {
    accountExperience: {
      account: {
        ...
        passwordUpdated: 'Пароль обновлён, другие авторизованные сессии отозваны.',
        ...
        twoFactorIntro:
          'Защитите вход приложением TOTP. Коды восстановления отображаются только при создании или повторной генерации.',
        ...
        passwordIntro:
          'Смена пароля отзывает персональные токены доступа и завершает другие авторизованные сессии.',
        currentPassword: 'Текущий пароль',
        newPassword: 'Новый пароль',
        confirmNewPassword: 'Подтвердите новый пароль',
        updatePassword: 'Обновить пароль',
        sessionsTitle: 'Другие сессии',
        sessionsIntro: 'Отозвать все авторизованные сессии, кроме этого устройства.',
  ...
  th: {
    accountExperience: {
      account: {
        ...
        twoFactorIntro:
          'ปกป้องการเข้าสู่ระบบด้วยแอป TOTP รหัสกู้คืนจะแสดงเฉพาะตอนสร้างหรือสร้างใหม่',
