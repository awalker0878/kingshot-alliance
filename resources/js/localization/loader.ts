...
export async function loadDomains(locale: LocaleCode, domains: readonly LocalizationDomain[]): Promise<void> { await Promise.all([...new Set(domains)].map((domain) => loadDomain(locale, domain))); }
