  ...
  <AuthLayout>
    ...
    >
      <svg aria-hidden="true" class="h-5 w-5" viewBox="0 0 24 24">
        ...
        <path fill="#34A853" d="M12 22c2.7 0 4.97-.9 6.62-2.41l-3.24-2.51c-.9.6-2.05.96-3.38.96-2.61 0-4.82-1.76-5.61-4.13H3.04v2.59A10 10 0 0 0 12 22Z" />
        <path fill="#FBBC05" d="M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.31.31-1.91V7.5H3.04A10 10 0 0 0 2 12c0 1.61.38 3.14 1.04 4.5l3.35-2.59Z" />
        <path fill="#EA4335" d="M12 5.96c1.47 0 2.79.51 3.83 1.5l2.87-2.88A9.63 9.63 0 0 0 12 2 10 10 0 0 0 3.04 7.5l3.35 2.59C7.18 7.72 9.39 5.96 12 5.96Z" />
      </svg>
    ...
    <div v-if="props.googleAuthEnabled" class="my-6 flex items-center gap-3" aria-hidden="true">
      ...
      <span class="text-xs uppercase tracking-[0.16em] text-[var(--ks-muted)]">or</span>
      <span class="h-px flex-1 bg-[var(--ks-border)]" />
    </div>

    <form :class="props.googleAuthEnabled ? 'space-y-5' : 'mt-7 space-y-5'" @submit.prevent="submit">
      <div>
