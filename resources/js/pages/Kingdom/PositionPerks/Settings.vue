    ...
    >
      <template #actions
        ...
        ><Link
          ...
          >{{ t('governanceExpansion.rolesTitle') }}</Link
        ><Link
          v-if="canManageKingdomRoles"
          href="/alliance/settings/kingdom/governance/health"
          class="ks-command-link"
          >{{ t('governanceExpansion.healthTitle') }}</Link
        ></template
      >
    </RoomBanner>
    <section class="ks-surface-gold mt-5 p-5 sm:p-6">
