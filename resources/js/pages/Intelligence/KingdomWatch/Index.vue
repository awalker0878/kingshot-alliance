...
<template>
  ...
  <AppLayout :user="user" :player-alliance-name="alliance.name" :has-player-alliance="true">
    <RoomBanner eyebrow="Intel Room" title="Kingdom Alliances" :subtitle="`Track Alliances in ${alliance.kingdom ? `Kingdom ${alliance.kingdom}` : 'your Kingdom'}, review Scout Reports, and keep diplomacy current.`" image="/images/kingshot/intel-room.svg">
      <template #actions><Link v-if="canManage" href="/alliance/kingdom-alliances/manage" class="ks-command-link">Tracking Orders</Link><Link href="/alliance/kingdom-alliances/intelligence" class="ks-command-link">Alliance Dossiers</Link></template>
    </RoomBanner>
