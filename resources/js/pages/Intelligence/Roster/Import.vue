  ...
  <AppLayout>
    <header class="flex flex-wrap items-start justify-between gap-4">
      ...
      <div class="flex flex-wrap gap-2">
        <a
          class="inline-flex min-h-10 items-center justify-center rounded-[var(--ks-radius-sm)] border border-[var(--ks-border)] px-3 py-2 text-xs font-semibold text-[var(--ks-text-secondary)] transition hover:border-[var(--ks-border-strong)] hover:text-[var(--ks-ivory)]"
          href="/alliance/roster/export.csv?scope=member"
        >
          {{ t('rosterImport.exportCurrent') }}
        </a>
        <a
          class="inline-flex min-h-10 items-center justify-center rounded-[var(--ks-radius-sm)] border border-[var(--ks-gold)]/45 bg-[var(--ks-gold-soft)] px-3 py-2 text-xs font-semibold text-[var(--ks-gold-strong)] transition hover:border-[var(--ks-gold)] hover:text-[var(--ks-ivory)]"
    ...
    <section class="mt-6 grid gap-5 xl:grid-cols-3">
      <article class="ks-surface-gold p-5 sm:p-6 xl:col-span-2">
        ...
        <form class="mt-5" @submit.prevent="preview">
          ...
          />
          <button
            class="mt-4 min-h-10 rounded-[var(--ks-radius-sm)] bg-[var(--ks-blue)] px-4 py-2 text-sm font-semibold text-[var(--ks-ivory)] transition hover:bg-[var(--ks-blue-strong)] disabled:opacity-60"
    ...
    <template v-if="importRecord">
      <section class="ks-surface-gold mt-6 overflow-hidden">
        ...
        >
          ...
          <div class="p-4">
            <dt class="text-[0.68rem] font-bold tracking-[0.1em] text-[var(--ks-gold)] uppercase">
          ...
          <table class="w-full min-w-[64rem] text-sm">
            ...
            <tbody class="divide-y divide-[var(--ks-border)]">
              <tr
                v-for="row in importRecord.rows"
                :key="row.row"
                class="align-top transition hover:bg-[var(--ks-parchment)]/[0.025]"
              >
      ...
      <section v-if="importRecord.status !== 'committed'" class="ks-surface mt-4 p-5">
        ...
        <button
          class="mt-3 min-h-10 rounded-[var(--ks-radius-sm)] bg-[var(--ks-blue)] px-4 py-2 text-sm font-semibold text-[var(--ks-ivory)] transition hover:bg-[var(--ks-blue-strong)] disabled:opacity-60"
          :disabled="
