      ...
      <div class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_20rem]">
        ...
        >
          ...
          <button
            ...
            class="rounded bg-[var(--ks-gold)] px-5 py-2.5 font-bold text-slate-950"
          >
        ...
        <div class="mt-4 grid gap-5 lg:grid-cols-[minmax(0,1fr)_22rem]">
          ...
          >
            ...
            ><button
              ...
              class="w-full rounded bg-[var(--ks-gold)] px-3 py-2 text-sm font-bold text-slate-950"
            >
                    ...
                    <button
                      ...
                      :class="
                        row.attendance === status
                          ? 'border-[var(--ks-gold)] bg-[var(--ks-gold)] text-slate-950'
