      ...
      <div class="mx-auto max-w-7xl px-5 py-12 sm:py-16 lg:px-8 lg:py-20">
        ...
        <div class="mt-8 flex flex-wrap items-center gap-3">
          ...
          <Link
            ...
            class="rounded-[var(--ks-radius-sm)] bg-[var(--ks-gold)] px-5 py-2.5 text-sm font-bold text-slate-950 transition hover:bg-[var(--ks-gold-strong)]"
    ...
    >
      ...
      <form class="ks-surface mt-7 grid gap-4 p-5 lg:grid-cols-12" @submit.prevent="applyFilters">
        ...
        <div class="flex flex-wrap gap-3 lg:col-span-12">
          <button
            class="rounded-[var(--ks-radius-sm)] bg-[var(--ks-blue)] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[var(--ks-blue-strong)]"
            type="submit"
          >
