    ...
    <div class="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(22rem,0.85fr)]">
      <section class="ks-surface p-5 sm:p-6">
        ...
        <form class="mt-6 grid gap-5 md:grid-cols-2" @submit.prevent="updateProfile">
          ...
          <div class="flex items-end">
            <button
              class="rounded-[var(--ks-radius-sm)] bg-[var(--ks-gold)] px-4 py-2.5 font-bold text-slate-950 transition hover:bg-[var(--ks-gold-strong)] disabled:cursor-not-allowed disabled:opacity-60"
      ...
      <section class="ks-surface-gold p-5 sm:p-6">
        ...
        <button
          ...
          class="mt-6 rounded-[var(--ks-radius-sm)] bg-[var(--ks-gold)] px-4 py-2.5 font-bold text-slate-950 transition hover:bg-[var(--ks-gold-strong)]"
          type="button"
