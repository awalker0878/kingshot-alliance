        ...
        <article v-for="entry in entries" :key="entry.id" class="ks-surface overflow-hidden">
          <div class="border-b border-[var(--ks-border)] bg-black/15 p-4 sm:p-5">
            ...
            <div class="mt-4 flex flex-wrap gap-2">
              <Link
                class="inline-flex min-h-9 items-center rounded-[var(--ks-radius-sm)] border border-[var(--ks-border)] px-3 py-1.5 text-xs font-semibold text-[var(--ks-blue-strong)] transition hover:border-[var(--ks-blue-strong)] hover:text-[var(--ks-ivory)]"
          ...
          <div class="grid gap-4 p-4 sm:grid-cols-2 sm:p-5">
            ...
            <div class="sm:col-span-2">
              <button
                class="min-h-10 rounded-[var(--ks-radius-sm)] border border-[var(--ks-gold)]/45 bg-[var(--ks-gold-soft)] px-4 py-2 text-sm font-semibold text-[var(--ks-gold-strong)] transition hover:border-[var(--ks-gold)] hover:text-[var(--ks-ivory)]"
                type="button"
