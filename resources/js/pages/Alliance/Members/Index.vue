  ...
  <AppLayout :user="user" :player-alliance-name="alliance.name" :has-player-alliance="true">
    <header class="flex flex-wrap items-start justify-between gap-4">
      ...
      <div class="flex flex-wrap gap-3">
        ...
        <Link
          v-if="canManage"
          class="inline-flex min-h-11 items-center justify-center rounded-[var(--ks-radius-sm)] bg-[var(--ks-blue)] px-4 py-2 text-sm font-semibold text-[var(--ks-ivory)] transition hover:bg-[var(--ks-blue-strong)]"
    ...
    <div class="mt-6 grid gap-5 xl:grid-cols-4">
        ...
        <section class="ks-surface p-4 sm:p-5">
          ...
          >
            ...
            <div class="flex flex-wrap items-end gap-2 md:col-span-2 xl:col-span-6">
              <button
                class="min-h-10 rounded-[var(--ks-radius-sm)] bg-[var(--ks-blue)] px-4 py-2 text-sm font-semibold text-[var(--ks-ivory)] transition hover:bg-[var(--ks-blue-strong)]"
                type="submit"
              >
                {{ t('roster.apply') }}
              </button>
              <button
                class="min-h-10 rounded-[var(--ks-radius-sm)] border border-[var(--ks-border)] px-4 py-2 text-sm font-semibold text-[var(--ks-text-secondary)] transition hover:border-[var(--ks-border-strong)] hover:text-[var(--ks-ivory)]"
                type="button"
                @click="clearFilters"
              >
                {{ t('roster.clear') }}
          ...
          <div v-if="entries.length" class="lg:hidden">
            ...
            >
              <div class="flex items-start justify-between gap-3">
                <div class="min-w-0">
                  <Link
                    class="block truncate text-base font-semibold text-[var(--ks-blue-strong)] hover:text-[var(--ks-ivory)]"
              ...
              <tbody class="divide-y divide-[var(--ks-border)]">
                ...
                >
                  <td class="px-4 py-3.5 font-semibold">
                    <Link
                      class="text-[var(--ks-blue-strong)] hover:text-[var(--ks-ivory)]"
                      :href="`/alliance/roster/${entry.id}/history`"
                    >
                      {{ entry.latestSnapshot?.observedName ?? entry.name }}
                    </Link>
      ...
      <aside class="space-y-4 xl:col-span-1" :aria-label="t('roster.intelligence')">
        <section class="ks-surface p-5 xl:sticky xl:top-24">
          ...
          <Link
            class="mt-4 inline-flex min-h-10 w-full items-center justify-center rounded-[var(--ks-radius-sm)] border border-[var(--ks-gold)]/45 bg-[var(--ks-gold-soft)] px-4 py-2 text-sm font-semibold text-[var(--ks-gold-strong)] transition hover:border-[var(--ks-gold)] hover:text-[var(--ks-ivory)]"
            href="/alliance/roster/intelligence"
          >
            {{ t('roster.intelligence') }}
          </Link>
          <Link
            v-if="canManage"
            class="mt-2 inline-flex min-h-10 w-full items-center justify-center rounded-[var(--ks-radius-sm)] border border-[var(--ks-border)] px-4 py-2 text-sm font-semibold text-[var(--ks-text-secondary)] transition hover:border-[var(--ks-border-strong)] hover:text-[var(--ks-ivory)]"
            href="/alliance/roster/manage"
          >
            {{ t('roster.manage') }}
          </Link>
