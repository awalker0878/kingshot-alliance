...
<template>
  <button
    :type="type"
    :disabled="disabled"
    class="inline-flex min-h-11 items-center justify-center gap-2 rounded-[var(--ks-radius-sm)] border px-4 py-2.5 font-[var(--ks-font-display)] text-sm font-semibold transition disabled:cursor-not-allowed disabled:opacity-45"
