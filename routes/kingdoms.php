...
Route::middleware(['auth', 'auth.session', 'verified', 'alliance.context'])->group(function (): void {
    ...
    Route::get('/alliance/roster', [RosterController::class, 'index'])->name('alliance.roster.index');
    Route::get('/alliance/roster/manage', [RosterController::class, 'manage'])->name('alliance.roster.manage');
    Route::get('/alliance/roster/intelligence', [RosterIntelligenceController::class, 'index'])->name('alliance.roster.intelligence');
    Route::get('/alliance/roster/import', [RosterCsvController::class, 'index'])->name('alliance.roster.import.index');
    Route::get('/alliance/roster/import/{import}', [RosterCsvController::class, 'show'])->name('alliance.roster.import.show');
    Route::get('/alliance/roster/export.csv', [RosterCsvController::class, 'export'])->name('alliance.roster.export');
    Route::get('/alliance/roster/{entry}/history', [PlayerSnapshotController::class, 'show'])->name('alliance.roster.history');
    ...
    Route::get('/alliance/kingdom-sharing', [KingdomIntelligenceSharingController::class, 'index'])->name('alliance.kingdom-sharing.index');
    Route::get('/alliance/kingdom-sharing/manage', [KingdomIntelligenceSharingController::class, 'manage'])->name('alliance.kingdom-sharing.manage');
