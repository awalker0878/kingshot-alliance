...
use App\Workflows\KingdomTransfer\Enums\KingdomAllianceContactState;
...
final class KingdomAllianceDiplomacyContactTest extends TestCase
{
    ...
    public function test_contact_mutations_require_recent_password_confirmation(): void
    {
        ...
        $staleSession = [
            (string) config('game_world.active_player_session_key') => Player::query()->where('user_id', $owner->id)->sole()->id,
