...
final class ContentAccessibilityGuardV2Test extends TestCase
{
    ...
    public function test_content_pages_keep_structural_accessibility_guards(string $path): void
    {
    ...
    private function assertMainLandmark(string $path, string $source): void
    {
        ...
        self::assertIsString($layout);
        self::assertStringContainsString('<main id="main-content"', $layout, 'AppLayout must expose the main landmark.');
    }
}
