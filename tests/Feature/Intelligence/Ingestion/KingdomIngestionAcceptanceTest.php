...
use App\Contexts\Intelligence\Ingestion\Actions\RunKingdomIngestionSubscription;
...
final class KingdomIngestionAcceptanceTest extends TestCase
{
    ...
    {
        self::assertSame([], config('intelligence.ingestion_adapters'));

        config()->set('intelligence.ingestion_adapters', [KingdomIngestionAcceptanceFixtureAdapter::class]);
        config()->set('intelligence.ingestion_retention', [
            'payload_days' => 10,
        ...
        config()->set('intelligence.ingestion_health', [
            'overdue_minutes' => 5,
