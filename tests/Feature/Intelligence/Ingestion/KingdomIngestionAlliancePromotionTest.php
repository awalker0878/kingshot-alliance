...
use App\Contexts\Intelligence\Ingestion\Actions\PromoteKingdomIngestionAllianceObservation;
...
final class KingdomIngestionAlliancePromotionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config()->set('intelligence.ingestion_adapters', [AlliancePromotionFixtureAdapter::class]);
    }
