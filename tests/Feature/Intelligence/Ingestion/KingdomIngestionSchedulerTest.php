...
use App\Contexts\Intelligence\Ingestion\Jobs\RunKingdomIngestionSubscriptionJob;
...
final class KingdomIngestionSchedulerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config()->set('intelligence.ingestion_adapters', [ScheduledIngestionFixtureAdapter::class]);
    ...
    public function test_manager_replay_requires_password_confirmation_and_re_drives_existing_promotion_action(): void
    {
        ...
        self::assertSame(1, DB::table('audit_events')
            ...
            ->where('event', 'intelligence.ingestion_replay_requested')
            ->count());
    }
