        ...
        foreach ($iterator as $file) {
            ...
            foreach ($forbidden as $namespace) {
                self::assertStringNotContainsString(
                    $namespace,
                    $contents,
                    $file->getPathname().' references '.$namespace,
                );
            }
        }
    }
