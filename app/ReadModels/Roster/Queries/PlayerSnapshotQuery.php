...
final class PlayerSnapshotQuery
{
     ...
     */
    public function latestForEntries(string $allianceId, iterable $entries): array
    {
    ...
    public function latestForEntry(string $allianceId, AllianceRosterEntry $entry): ?PlayerSnapshot
    {
