...
final class EventKingdomAllianceResultMetric extends Model
{
    use HasUlids;
    ...
    protected $fillable = [
        'event_kingdom_alliance_result_id',
    ...
    /** @return BelongsTo<EventKingdomAllianceResult, $this> */
    public function result(): BelongsTo
    {
        return $this->belongsTo(EventKingdomAllianceResult::class, 'event_kingdom_alliance_result_id');
    }
