...
final class KingdomWriteState
{
    public function lockExclusiveScope(string $actorPlayerId, string $kingdomId): KingdomMutationContext
    {
        ...
        $currentKingdom = Kingdom::query()->whereKey($kingdomId)->lockForUpdate()->firstOrFail();
        ...
        if ((string) $currentActor->current_kingdom_id !== (string) $currentKingdom->id || $currentActor->canonical_player_id !== null) {
            throw new AuthorizationException;
        }
