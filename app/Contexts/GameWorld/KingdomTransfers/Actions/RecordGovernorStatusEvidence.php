...
final readonly class RecordGovernorStatusEvidence
{
    ...
    public function handle(
        ...
        return DB::transaction(function () use ($allianceId, $actorPlayerId, $planId, $participantId, $expectedWindowId, $evidenceId, $reviewId, $schemaVersion, $idempotencyKey, $governorPower, $observedAt, $validUntil): TransferEvidenceDestinationReceipt {
            ...
            return $this->support->complete(
                ...
                $schemaVersion,
                $idempotencyKey,
                ['governor_power_observation_id' => $observationId],
            );
        });
    }
}
