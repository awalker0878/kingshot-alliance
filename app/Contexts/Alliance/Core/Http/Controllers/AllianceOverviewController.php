...
final class AllianceOverviewController extends Controller
{
    public function __invoke(
        ...
        $canManageInvitations = $authorization->allows($actor, $alliance, AlliancePermission::InvitationManage);
        ...
        $upcomingActivities = $upcomingActivitiesQuery->handle($alliance);
