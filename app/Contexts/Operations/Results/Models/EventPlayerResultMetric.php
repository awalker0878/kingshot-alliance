...
final class EventPlayerResultMetric extends Model
{
    use HasUlids;
    ...
    /** @return BelongsTo<EventPlayerResult, $this> */
    public function result(): BelongsTo
    {
        return $this->belongsTo(EventPlayerResult::class, 'event_player_result_id');
    }
