...
final class EventAllianceResultMetric extends Model
{
    use HasUlids;
    ...
    /** @return BelongsTo<EventAllianceResult, $this> */
    public function result(): BelongsTo
    {
        return $this->belongsTo(EventAllianceResult::class, 'event_alliance_result_id');
    }
