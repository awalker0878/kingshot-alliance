...
final class EventAllianceResult extends Model
{
    use HasUlids;
    ...
    /** @return HasMany<EventAllianceResultMetric, $this> */
    public function metrics(): HasMany
    {
        return $this->hasMany(EventAllianceResultMetric::class, 'event_alliance_result_id');
    }
}
