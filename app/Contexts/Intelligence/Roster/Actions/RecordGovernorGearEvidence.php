...
final readonly class RecordGovernorGearEvidence extends RecordsGovernorProgressionEvidence
{
    ...
    {
        return $this->record(EvidenceKind::GovernorGear, 'governor-gear/1', $actorPlayerId, $allianceId, $rosterEntryId, $evidenceId, $reviewId, $schemaVersion, $progressionDatasetId, $progressionDatasetChecksum, $capturedAt, $payload, $idempotencyKey);
    }
}
