...
final readonly class RecordHeroRosterEvidence extends RecordsGovernorProgressionEvidence
{
    ...
    {
        return $this->record(EvidenceKind::GovernorHeroRoster, 'governor-hero-roster/1', $actorPlayerId, $allianceId, $rosterEntryId, $evidenceId, $reviewId, $schemaVersion, $progressionDatasetId, $progressionDatasetChecksum, $capturedAt, $payload, $idempotencyKey);
    }
}
