...
final readonly class RecordGovernorCharmsEvidence extends RecordsGovernorProgressionEvidence
{
    ...
    {
        return $this->record(EvidenceKind::GovernorCharms, 'governor-charms/1', $actorPlayerId, $allianceId, $rosterEntryId, $evidenceId, $reviewId, $schemaVersion, $progressionDatasetId, $progressionDatasetChecksum, $capturedAt, $payload, $idempotencyKey);
    }
}
