...
final readonly class RecordHeroDetailEvidence extends RecordsGovernorProgressionEvidence
{
    ...
    {
        return $this->record(EvidenceKind::GovernorHeroDetail, 'governor-hero-detail/1', $actorPlayerId, $allianceId, $rosterEntryId, $evidenceId, $reviewId, $schemaVersion, $progressionDatasetId, $progressionDatasetChecksum, $capturedAt, $payload, $idempotencyKey);
    }
}
