...
final readonly class RecordHeroGearEvidence extends RecordsGovernorProgressionEvidence
{
    ...
    {
        return $this->record(EvidenceKind::GovernorHeroGear, 'governor-hero-gear/1', $actorPlayerId, $allianceId, $rosterEntryId, $evidenceId, $reviewId, $schemaVersion, $progressionDatasetId, $progressionDatasetChecksum, $capturedAt, $payload, $idempotencyKey);
    }
}
