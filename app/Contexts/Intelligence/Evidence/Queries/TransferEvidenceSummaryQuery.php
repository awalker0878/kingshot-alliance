        ...
        foreach ($evidence as $item) {
            ...
            $result[$participantId][] = [
                ...
                'review' => $review instanceof TransferEvidenceReview ? [
                    ...
                    'targetHeroGeneration' => $review->target_hero_generation,
                    'targetTruegoldLevel' => $review->target_truegold_level,
                    'targetCharacterAgeThresholdDays' => $review->target_character_age_threshold_days,
