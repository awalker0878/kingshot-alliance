...
final class GovernorProgressionEvidenceSchemaRegistry
{
    public function require(EvidenceKind $kind): GovernorProgressionEvidenceSchema
    {
        return match ($kind) {
            ...
            EvidenceKind::GovernorBuildings => new GovernorProgressionEvidenceSchema(
                kind: $kind,
                version: 'governor-buildings/1',
                supportedFields: ['building_name', 'building_level'],
                requiredFields: ['building_name', 'building_level'],
                minimumClassificationConfidence: 0.60,
                minimumFieldConfidence: 0.55,
                fixtureCorpus: 'governor-buildings-v1',
                destinationAction: 'RecordStructuredProgressionEvidence',
            ),
            EvidenceKind::GovernorAcademyResearch => new GovernorProgressionEvidenceSchema(
                kind: $kind,
                version: 'governor-academy-research/1',
                supportedFields: ['technology_name', 'research_level'],
                requiredFields: ['technology_name', 'research_level'],
                minimumClassificationConfidence: 0.60,
                minimumFieldConfidence: 0.55,
                fixtureCorpus: 'governor-academy-research-v1',
                destinationAction: 'RecordStructuredProgressionEvidence',
            ),
            EvidenceKind::GovernorWarAcademyResearch => new GovernorProgressionEvidenceSchema(
                kind: $kind,
                version: 'governor-war-academy-research/1',
                supportedFields: ['technology_name', 'research_level'],
                requiredFields: ['technology_name', 'research_level'],
                minimumClassificationConfidence: 0.60,
                minimumFieldConfidence: 0.55,
                fixtureCorpus: 'governor-war-academy-research-v1',
                destinationAction: 'RecordStructuredProgressionEvidence',
            ),
