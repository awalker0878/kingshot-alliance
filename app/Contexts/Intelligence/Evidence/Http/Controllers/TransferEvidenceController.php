...
final class TransferEvidenceController extends Controller
{
    ...
    public function preview(
        ...
        $result = $preview->preview(
            ...
            new TransferEvidencePreviewInput(
                ...
                targetHeroGeneration: $item->target_hero_generation,
                targetTruegoldLevel: $item->target_truegold_level,
                targetCharacterAgeThresholdDays: $item->target_character_age_threshold_days,
    ...
    public function review(
        ...
        $validated = $request->validate([
            ...
            'hero_generation' => ['nullable', 'integer', 'min:0'],
            'truegold_level' => ['nullable', 'integer', 'min:0'],
            'character_age_threshold_days' => ['nullable', 'integer', 'min:90', 'max:180'],
        ...
        $reviewId = $save->handle(
            ...
            targetHeroGeneration: isset($validated['hero_generation']) ? (int) $validated['hero_generation'] : null,
            targetTruegoldLevel: isset($validated['truegold_level']) ? (int) $validated['truegold_level'] : null,
            targetCharacterAgeThresholdDays: isset($validated['character_age_threshold_days']) ? (int) $validated['character_age_threshold_days'] : null,
