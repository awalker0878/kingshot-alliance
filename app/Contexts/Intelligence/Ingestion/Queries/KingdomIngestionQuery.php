...
final class KingdomIngestionQuery
{
    ...
    public function subscriptionsForAlliance(string $allianceId): Collection
    {
    ...
    public function recentCandidatesForAlliance(string $allianceId, int $limit = 50): Collection
    {
